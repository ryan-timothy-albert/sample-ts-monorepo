...
async function run() {
  const result = await financeSDK.pet.myNewTest({
    id: 10,
    name: "doggie",
    category: {
      id: 1,
...
```typescript
import { FinanceSDKCore } from "ryan-finance/core.js";
import { petMyNewTest } from "ryan-finance/funcs/petMyNewTest.js";
...
async function run() {
  const res = await petMyNewTest(financeSDK, {
    id: 10,
    name: "doggie",
    category: {
      id: 1,
...
async function run() {
  const result = await financeSDK.pet.findPetsByStatusTypes({});
...
```typescript
import { FinanceSDKCore } from "ryan-finance/core.js";
import { petFindPetsByStatusTypes } from "ryan-finance/funcs/petFindPetsByStatusTypes.js";
...
async function run() {
  const res = await petFindPetsByStatusTypes(financeSDK, {});
...
async function run() {
  const result = await financeSDK.pet.findPetsByTags({});
...
```typescript
import { FinanceSDKCore } from "ryan-finance/core.js";
import { petFindPetsByTags } from "ryan-finance/funcs/petFindPetsByTags.js";
...
async function run() {
  const res = await petFindPetsByTags(financeSDK, {});
...
async function run() {
  const result = await financeSDK.pet.getPetByIDS({
    petId: 137396,
  });
...
```typescript
import { FinanceSDKCore } from "ryan-finance/core.js";
import { petGetPetByIDS } from "ryan-finance/funcs/petGetPetByIDS.js";
...
async function run() {
  const res = await petGetPetByIDS(financeSDK, {
    petId: 137396,
  });
...
async function run() {
  const result = await financeSDK.pet.deletePet({
    petId: 441876,
  });
...
```typescript
import { FinanceSDKCore } from "ryan-finance/core.js";
import { petDeletePet } from "ryan-finance/funcs/petDeletePet.js";
...
async function run() {
  const res = await petDeletePet(financeSDK, {
    petId: 441876,
  });
...
async function run() {
  const result = await financeSDK.pet.uploadFile({
    petId: 565380,
  });
...
```typescript
import { FinanceSDKCore } from "ryan-finance/core.js";
import { petUploadFile } from "ryan-finance/funcs/petUploadFile.js";
...
async function run() {
  const res = await petUploadFile(financeSDK, {
    petId: 565380,
  });
